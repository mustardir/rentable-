/*
  ...
  - You are about to create enums and tables for Fortress Fund API initial auth/KYC foundations.
*/

-- CreateEnum
CREATE TYPE "Role" AS ENUM ('USER', 'ADMIN', 'COMPLIANCE');

-- CreateEnum
CREATE TYPE "KYCStatus" AS ENUM ('PENDING', 'IN_REVIEW', 'APPROVED', 'REJECTED');

-- CreateEnum
CREATE TYPE "KYCLevel" AS ENUM ('TIER_0', 'TIER_1', 'TIER_2', 'TIER_3');
...
CREATE TABLE "KYCRecord" (
    ...
    "level" "KYCLevel" NOT NULL DEFAULT 'TIER_0',
    "documentType" TEXT,
    "documentNumber" TEXT,
